    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-8 max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Qbuyse Refund Policy</h2>
          ...
          <div className="space-y-6">
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">1. Marketplace Nature</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">2. Direct Transactions</h3>
              <p className="text-gray-600">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">3. Dispute Resolution</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">4. Platform Fees</h3>
              <p className="text-gray-600">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">6. Refund Guidelines</h3>
              <p className="text-gray-600 mb-3">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">7. Safety Measures</h3>
              <p className="text-gray-600 mb-3">For your safety:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">8. Contact Support</h3>
              <p className="text-gray-600">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">9. Policy Updates</h3>
              <p className="text-gray-600">
